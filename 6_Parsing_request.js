// Lession6: Parsing request. stream, chunk and buffer concept

const http = require('http');
const fs = require('fs');
requerstLitener = (req,res ) =>{console.log(req.url, req.method);
...
// when a new chunk is given 
  ...
  req.on("end", ()=>{
    ...
    fs.writeFile("6_output.txt", JSON.stringify(bodyobject), (error)=>{if (error){ throw error}});
  }
  );
